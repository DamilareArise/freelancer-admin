...
const AdsCategoryChart = () => {
  const chartData = React.useMemo(
    () => [
      { label: "Homepage", value: 6400, fill: "var(--primary-1000)" },
      { label: "Top Category", value: 1400, fill: "var(--primary-600)" },
      { label: "Highlight", value: 1400, fill: "var(--primary-200)" },
    ],
    []
  )
  ...
  return (
    <Card className="flex flex-col h-full shadow-none py-4">
      <CardHeader className="flex-row justify-center items-start space-y-0 pb-0 px-3">
        <CardTitle className="mt-5">Top Ads Category</CardTitle>
      </CardHeader>
...
export default AdsCategoryChart
